export const importSources = [
  ...
  {id:'src-bit',name:'Bit',type:'bit_wallet',owner:'משק הבית',method:'BitImportSource · API נתמך בלבד',mode:'automatic',status:'waiting_connection',lastAttempt:null,lastSuccess:null,nextSync:null,freshnessHours:24,consecutiveFailures:0,requiredForCompleteness:false,pendingIssues:0},
  {id:'src-paybox',name:'PayBox',type:'paybox_wallet',owner:'משק הבית',method:'PayBoxImportSource · fallback דרך מקורות אחרים',mode:'semi_automatic',status:'waiting_connection',lastAttempt:null,lastSuccess:null,nextSync:null,freshnessHours:24,consecutiveFailures:0,requiredForCompleteness:false,pendingIssues:0},
