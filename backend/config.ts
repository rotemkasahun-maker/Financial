export function loadConfig(env=process.env){
  ...
  return {
    ...
    gmailClientId:get('GMAIL_CLIENT_ID')||null,
    gmailClientSecret:get('GMAIL_CLIENT_SECRET')||null,
    gmailRedirectUri:get('GMAIL_REDIRECT_URI')||`${get('PUBLIC_BASE_URL')||'http://127.0.0.1:8080'}/oauth/gmail/callback`,
    gmailPubsubTopic:get('GMAIL_PUBSUB_TOPIC')||null,
    stateEncryptionKey:get('STATE_ENCRYPTION_KEY')||null,
    ...
    gmailConfigured:Boolean(get('GMAIL_CLIENT_ID')&&get('GMAIL_CLIENT_SECRET')&&get('GMAIL_PUBSUB_TOPIC')&&get('STATE_ENCRYPTION_KEY'))
  };
}
